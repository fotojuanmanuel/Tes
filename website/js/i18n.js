(function () {
    ...
    const indexBindings = [
        ['.logo h1', 'Portal Internacional de Prensa', 'International Press Portal'],
        ['.nav-link[href="#inicio"]', 'Inicio', 'Home'],
        ['.nav-link[href="#noticias"]', 'Noticias', 'News'],
        ['.nav-link[href="#comunicados"]', 'Comunicados', 'Press Releases'],
        ['.nav-link[href="#eventos"]', 'Eventos', 'Events'],
        ['.nav-link[href="#contacto"]', 'Contacto', 'Contact'],
